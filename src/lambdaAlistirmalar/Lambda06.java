...
public class Lambda06 {
    public static void main(String[] args) throws IOException {
        ...
        Files.
                lines(Paths.get("src/lambdaAlistirmalar/haluk.txt")).//file erisip  file satirlari akis alindi
        ...
        Files.lines(Paths.get("src/lambdaAlistirmalar/haluk.txt")).map(String::toUpperCase).forEach(System.out::println);
        ...
        Files.lines(Paths.get("src/lambdaAlistirmalar/haluk.txt")).
                limit(1).map(String::toLowerCase).forEach(System.out::println);

        //TASK 04 --> haluk.txt dosyasinda "basari" kelimesinin kac satirda gectiginiz yazdiriniz
        System.out.println("\n*** haluk.txt dosyasinda basari kelimesinin kac satirda gectiginiz yazdiriniz -->  ");
        System.out.println(Files.lines(Paths.get("src/lambdaAlistirmalar/haluk.txt")).filter(t -> t.contains("basari")).count());

        //TASK 05 --> haluk.txt dosyasindaki farkli kelimeleri  yazdiriniz.
        System.out.println("\n*** haluk.txt dosyasindaki farkli kelimeleri  yazdiriniz. -->  ");
        Files.lines(Paths.get("src/lambdaAlistirmalar/haluk.txt")). map(t -> t.split(" ")).//" " gore satirlardaki elemanlari parcalayip array'a atadi
        ...
        Files.lines(Paths.get("src/lambdaAlistirmalar/haluk.txt")).map(t->t.toLowerCase().split(" ")).
